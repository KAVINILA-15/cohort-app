...
# ------------------------------
def login_page():
    st.markdown("<h2 style='color:#2196F3;'>🔑 Login Page</h2>", unsafe_allow_html=True)
...
def student_dashboard():
    st.markdown("<h2 style='color:#FF9800;'>📚 Student Dashboard</h2>", unsafe_allow_html=True)
...
def mentor_dashboard():
    st.markdown("<h2 style='color:#673AB7;'>👨‍🏫 Mentor Dashboard</h2>", unsafe_allow_html=True)
...
def floorwing_dashboard():
    st.markdown("<h2 style='color:#009688;'>🏢 Floorwing Dashboard</h2>", unsafe_allow_html=True)
...
# ------------------------------
def admin_dashboard():
    st.markdown("<h2 style='color:#E91E63;'>⚙️ Administrator Dashboard</h2>", unsafe_allow_html=True)
